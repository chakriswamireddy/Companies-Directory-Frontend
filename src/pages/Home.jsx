...
export default function CompanyList() {
    ...
    <div className="p-6">
      ...
      <div className="flex flex-wrap gap-4 mb-6">
        <input
          ...
          className="w-full sm:w-64 border px-3 py-2 rounded-lg shadow-sm focus:ring focus:ring-indigo-200 outline-none"
        />
          <select
          value={sortOrder}
  ...
  {companies?.map((company) => (
    <div
      key={company._id}
      className="rounded-lg border border-gray-200 shadow-sm p-4 flex flex-col items-center text-center"
    >
